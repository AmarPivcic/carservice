...
function darkMode() {
    ...
    var sectionList = document.querySelectorAll("#aboutus, #services, #location");
    var sectionArray=[...sectionList];
    sectionArray.forEach(element => {
        element.classList.toggle("darksection");
    });

    var textList = document.querySelectorAll("#aboutustitle, #servicestitle, #locationtitle, #aboutuscard, #enginetext, #gearboxtext, #othertext, #locationtext, #enginetitle, #gearboxtitle, #othertitle");
